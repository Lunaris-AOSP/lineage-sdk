...
public class Build {
    ...
    public static final String LUNARISOS_VERSION = getString("ro.lunaris.version");

    /** A build ID string meant for displaying to the user */
    public static final String LUNARISOS_DISPLAY_VERSION = getString("ro.lunaris.display.version");
